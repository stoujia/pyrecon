...
dir_motion_tp = '/home/INT/jia.s/Documents/PhD/v4/simu_siren_transfo2' #'/mnt/Data/Chloe/Resultats/manuscript/nesvor/tres_petit'
dir_nomvt_tp = '/home/INT/jia.s/Documents/PhD/v4/simu_siren_transfo2_nomvt'#'/mnt/Data/Chloe/Resultats/manuscript/svort_nomvt/tres_petit'
...
saving_folder = '/home/INT/jia.s/Documents/PhD/v4/a_quant_siren_old'
...
merging_folders(dir_nomvt_tp, [input.replace("moyen4", "nomvt") for input in input_folders], "motion_corrected")
...
#
    ...
    dir_motion = os.path.join(dir_motion_tp, "motion_corrected") #dir_motion_tp #for chloe
    dir_nomvt = os.path.join(dir_nomvt_tp, "motion_corrected") #+ str(index_image)  # dir_nomvt_tp #for chloe
